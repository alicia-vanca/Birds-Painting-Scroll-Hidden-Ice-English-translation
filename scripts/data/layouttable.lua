...
local icon_chs = {
    wasphive = "Killer Bee Nest",
    spidereggsack = "Spider Mine",
    ...
    flower_cave_double = "Bioluminescent Berry Plain",
    flower_cave_triple = "Tri-Luminescent Berry Plain",
    ...
    marblepillar = "Developer Graveyard",
    marbletree = "Chess Piece Easter Egg",
    sculpture_rook = "Three Bases Easter Egg",
    statuemaxwell = "Maxwell Easter Egg",
    hermithouse_construction1 = "Hermit Crab's Home",
    antlion_spawner = "Antlion Generation Point",
    ...
    saltstack = "Salt Mine",
    oceantree_pillar = "Underwater Tree",
